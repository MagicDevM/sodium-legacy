...
package net.caffeinemc.mods.sodium.client.render.model.material;
...
public class MaterialViewImpl implements MaterialView {
    ...
    protected static final int TRI_STATE_COUNT = TRI_STATES.length;
    protected static final int BLEND_MODE_COUNT = BLEND_MODES.length;
    ...
    protected static final int SHADE_MODE_COUNT = SHADE_MODES.length;
