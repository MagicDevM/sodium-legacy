...
public class LevelLoadingScreenMixin {
    ...
    public static void renderChunks(GuiGraphics graphics, StoringChunkProgressListener listener, int mapX, int mapY, int mapScale, int mapPadding) {
        ...
        // this is just missing the drawSpecial that doesn't exist on 1.21.1 but it works with bufferSource()
        var writer = VertexBufferWriter.of(graphics.bufferSource().getBuffer(RenderType.gui()));
