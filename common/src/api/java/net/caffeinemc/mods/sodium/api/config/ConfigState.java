...
public interface ConfigState {
     ...
     */
    Identifier UPDATE_ON_REBUILD = new Identifier("sodium").tryParse("__meta__:update_on_rebuild");
     ...
     */
    Identifier UPDATE_ON_APPLY = new Identifier("sodium").tryParse("__meta__:update_on_apply");
