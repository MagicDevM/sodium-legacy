...
public interface ConfigState {
     ...
     */
    Identifier UPDATE_ON_REBUILD = new Identifier.tryParse("__meta__:update_on_rebuild");
     ...
     */
    Identifier UPDATE_ON_APPLY = new Identifier.tryParse("__meta__:update_on_apply");
