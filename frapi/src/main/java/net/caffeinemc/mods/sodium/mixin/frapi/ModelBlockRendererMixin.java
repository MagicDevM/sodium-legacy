...
public abstract class ModelBlockRendererMixin {
    ...
    @Overwrite
    public static void renderModel(PoseStack.Pose pose, VertexConsumer vertexConsumer, BakedModel model, float red, float green, float blue, int light, int overlay) {
